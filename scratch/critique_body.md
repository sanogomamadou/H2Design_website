...
- **Fix**: Remove the `.sla-badge` box entirely from the Diaspora Hub column. Let the clean text links (`contact@h2designml.com` and `+223 74 14 99 14`) stand alone, relying on the CTA banner above for the SLA reassurance.
